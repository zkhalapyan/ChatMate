...
chatmate.utils.Logger=function(){return function($namespace$$){return{log:function($message$$){console.log($namespace$$+": "+$message$$)},debug:function($message$$){console.debug($namespace$$+": "+$message$$)},warn:function($message$$){console.warn($namespace$$+": "+$message$$)},error:function($message$$){console.error($namespace$$+": "+$message$$)},info:function($message$$){console.info($namespace$$+": "+$message$$)}}}}();
...
chatmate.controllers.ChatRoomsController=function(){return function(){var $that$$={},$chatRoomsMenuView$$=null,$openChatRoomCallback$$=function $$openChatRoomCallback$$$($title$$){return function(){chatmate.controllers.PageController.openChatRoomPage({title:$title$$})}};$that$$.addChatRoom=function $$that$$$addChatRoom$($chatRoomTitle$$){null!==$chatRoomsMenuView$$&&$chatRoomsMenuView$$.addItem($chatRoomTitle$$,$openChatRoomCallback$$($chatRoomTitle$$))};$that$$.renderChatRoomList=function $$that$$$renderChatRoomList$(){var $chatRooms_container$$=
chatmate.models.ChatRoomModelFactory.getAllActiveChatRooms(),$chatRoomList$$=[],$title$$;for($title$$ in $chatRooms_container$$)$chatRooms_container$$.hasOwnProperty($title$$)&&$chatRoomList$$.push({label:$title$$,callback:$openChatRoomCallback$$($title$$)});$chatRoomsMenuView$$=chatmate.views.ListView("Chat Rooms Menu",$chatRoomList$$,"No Chat Rooms Available");$chatRooms_container$$=document.createElement("div");$chatRooms_container$$.appendChild($chatRoomsMenuView$$.render());$chatRooms_container$$.appendChild(mwf.decorator.SingleClickButton("Create Room",
chatmate.controllers.PageController.openNewChatRoomPage));return $chatRooms_container$$};chatmate.services.ChatService.setOnMessageCallback(function($packet$$){chatmate.models.ChatRoomModelFactory.chatRoomExists($packet$$.room)||$that$$.addChatRoom($packet$$.room)});return $that$$}}();
chatmate.controllers.PageController=function(){var $that$$={},$pageHistoryStack$$=[],$pageCanvas$$=null,$logger$$=chatmate.utils.Logger("PageController"),$displayPage$$=function $$displayPage$$$($pageModel_pageView$$){$logger$$.info("Displaying page "+$pageModel_pageView$$.getPageTitle()+".");var $pageModel_pageView$$=chatmate.models.PageView($pageModel_pageView$$),$canvas$$;null===$pageCanvas$$&&($pageCanvas$$=document.getElementById("page-canvas"));$canvas$$=$pageCanvas$$;$canvas$$.innerHTML="";
$canvas$$.appendChild($pageModel_pageView$$.render())};$that$$.register=function $$that$$$register$($pageName$$,$initializer$$){$that$$["open"+$pageName$$]=$initializer$$};$that$$.render=function $$that$$$render$($pageModel$$){$logger$$.info("Adding page model "+$pageModel$$.getPageTitle()+" to history stack.");$pageHistoryStack$$.push($pageModel$$);$displayPage$$($pageModel$$)};$that$$.canGoBack=function $$that$$$canGoBack$(){return 1<$pageHistoryStack$$.length};$that$$.goBack=function $$that$$$goBack$(){$pageHistoryStack$$.pop();
$logger$$.info("goBack() invoked.");$displayPage$$($pageHistoryStack$$[$pageHistoryStack$$.length-1])};return $that$$}();
...
$(document).ready(function(){var $logger$$=chatmate.utils.Logger();chatmate.services.ChatServiceInitializer();chatmate.controllers.PageController.register("HomePage",chatmate.init.ChatRooms);chatmate.controllers.PageController.register("NewChatRoomPage",chatmate.init.NewChatRoom);chatmate.controllers.PageController.register("ChatRoomsView",chatmate.init.ChatRooms);chatmate.controllers.PageController.register("ChatRoomPage",chatmate.init.ChatRoomMessages);chatmate.controllers.PageController.register("NewChatRoomPage",
chatmate.init.NewChatRoom);chatmate.models.ChatRoomModelFactory.getChatRoomModel("OPT Tech Talk");chatmate.models.ChatRoomModelFactory.getChatRoomModel("MWF Friends");chatmate.controllers.PageController.openChatRoomsView();if(chatmate.utils.DeviceDetection.isDeviceAndroid()){var $androidBackButtonCallback$$=function $$androidBackButtonCallback$$$(){chatmate.controllers.PageController.canGoBack()?($logger$$.info("Go back invoked!"),chatmate.controllers.PageController.goBack()):navigator.app.exitApp()};
document.addEventListener("deviceready",function(){document.addEventListener("backbutton",$androidBackButtonCallback$$,!0)},!1)}else chatmate.services.ChatService.run()});
...
return $that$$}}();
chatmate.services.ChatServiceInitializer=function $chatmate$services$ChatServiceInitializer$(){var $JSCompiler_temp_const$$=chatmate.services,$that$$={},$logger$$=chatmate.utils.Logger("ChatService"),$messageQueue$$=[],$socket$$=null,$onMessageCallback$$,$isSocketOpen$$=!1,$onOpenHandler$$=function $$onOpenHandler$$$(){$logger$$.info("Opened connection.");$isSocketOpen$$=!0},$onMessageHandler$$=function $$onMessageHandler$$$($e$$){var $packet$$=$.parseJSON($e$$.data);$logger$$.info("Received message: "+$e$$.data);
chatmate.models.ChatRoomModelFactory.getChatRoomModel($packet$$.room).addMessage($packet$$.message);"function"===typeof $onMessageCallback$$&&$onMessageCallback$$($packet$$)},$onCloseHandler$$=function $$onCloseHandler$$$(){$isSocketOpen$$=!1};$that$$.setOnMessageCallback=function $$that$$$setOnMessageCallback$($newOnMessageCallback$$){$onMessageCallback$$=$newOnMessageCallback$$};$that$$.run=function $$that$$$run$(){null===$socket$$&&($logger$$.info("Starting WebSocket."),$socket$$=new WebSocket("ws://rocking-apps.com:8080"));
$socket$$.onerror=function $$socket$$$onerror$($e$$){$logger$$.error("Error occurred with the socket.");$logger$$.error($e$$)};$socket$$.onmessage=$onMessageHandler$$;$socket$$.onopen=$onOpenHandler$$;$socket$$.onclose=$onCloseHandler$$};$that$$.sendMessage=function $$that$$$sendMessage$($chatRoomModel$$,$message$$){$chatRoomModel$$.addMessage($message$$);var $packet$$={room:$chatRoomModel$$.getTitle(),message:$message$$};$isSocketOpen$$?($logger$$.info("Sent message: "+JSON.stringify($packet$$)),
$socket$$.send(JSON.stringify($packet$$))):$messageQueue$$.push($message$$)};$JSCompiler_temp_const$$.ChatService=$that$$};
chatmate.utils.CacheService=function(){var $cache$$={};return function($namespace$$){var $that$$={isSet:function($key$$){return void 0!==$cache$$[$namespace$$][$key$$]},set:function($key$$,$value$$){$cache$$[$namespace$$][$key$$]=$value$$},remove:function($key$$){$that$$.isSet($key$$)&&delete $cache$$[$namespace$$][$key$$]},removeAll:function(){$cache$$[$namespace$$]={}}};void 0===$namespace$$&&($namespace$$="global");void 0===$cache$$[$namespace$$]&&($cache$$[$namespace$$]={});return $that$$}}();
chatmate.utils.DeviceDetection=function(){var $that$$={},$userAgent$$=navigator.userAgent,$documentURL$$=document.URL;$that$$.isOnDevice=function $$that$$$isOnDevice$(){return $userAgent$$.match(/(iPhone|iPod|iPad|Android|BlackBerry)/)};$that$$.isDeviceiOS=function $$that$$$isDeviceiOS$(){return $userAgent$$.match(/(iPhone|iPod|iPad)/)};$that$$.isDeviceAndroid=function $$that$$$isDeviceAndroid$(){return $userAgent$$.match(/(Android)/)};$that$$.isNativeApplication=function $$that$$$isNativeApplication$(){return-1===
$documentURL$$.indexOf("http://")&&-1===$documentURL$$.indexOf("https://")};$that$$.setUserAgent=function $$that$$$setUserAgent$($newUserAgent$$){$userAgent$$=$newUserAgent$$};$that$$.setDocumentURL=function $$that$$$setDocumentURL$($newDocumentURL$$){$documentURL$$=$newDocumentURL$$};return $that$$}();
chatmate.utils.LocalMap=function $chatmate$utils$LocalMap$($name$$0$$){var $that$$={};void 0===localStorage[$name$$0$$]&&(localStorage[$name$$0$$]=JSON.stringify({}));$that$$.getMap=function $$that$$$getMap$(){return JSON.parse(localStorage[$name$$0$$])};$that$$.set=function $$that$$$set$($name$$,$object$$){var $map$$=$that$$.getMap();$map$$[$name$$]=$object$$;localStorage[$name$$0$$]=JSON.stringify($map$$)};$that$$.importMap=function $$that$$$importMap$($object$$){var $map$$=$that$$.getMap(),$key$$;
...
chatmate.views.ListView=function(){return function($title$$,$list$$,$emptyListMessage$$){var $that$$={},$menu$$=null,$isEmptyList$$=!1;$that$$.addItem=function $$that$$$addItem$($label$$,$callback$$){if(null!==$menu$$){$isEmptyList$$&&($menu$$.removeMenuItemAt(0),$isEmptyList$$=!1);var $menuItem$$=$menu$$.addMenuLinkItem($label$$);void 0!==$callback$$&&mwf.decorator.TouchEnabledItemModel.bindTouchEvent($menuItem$$,$menuItem$$,$callback$$,"menu-highlight")}};$that$$.render=function $$that$$$render$(){$menu$$=
...
chatmate.views.NewChatRoomMessageView=function(){return function($chatRoomController$$){var $that$$={},$user$$=chatmate.utils.LocalMap("user");$that$$.render=function $$that$$$render$(){var $form$$=mwf.decorator.Form("New Message");$form$$.addLabel("Username","username");$form$$.addTextBox("username","username",$user$$.get("username"));$form$$.addLabel("Your Message");$form$$.addTextBox("New Message","new-message");$form$$.addSubmitButton("Send Away");$($form$$).submit(function($e$$15_username$$){$e$$15_username$$.preventDefault();
var $e$$15_username$$=document.getElementById("username").value,$message$$=document.getElementById("new-message").value;0===$e$$15_username$$.length?alert("Please enter your username."):0===$message$$.length?alert("Sorry, no empty messages can be sent."):($chatRoomController$$.sendMessage({text:$message$$,username:$e$$15_username$$}),$user$$.set("username",$e$$15_username$$),document.getElementById("new-message").value="",document.activeElement.blur(),$("input").blur())});return $form$$};return $that$$}}();
chatmate.models.PageView=function(){return function($pageModel$$){return{render:function(){document.getElementById("header-title").innerHTML=$pageModel$$.getPageTitle();mwf.decorator.TopButton($pageModel$$.getTopButtonLabel(),null,$pageModel$$.getTopButtonCallback(),!0);var $headerLink$$=document.getElementById("header-link");mwf.decorator.TouchEnabledItemModel.bindTouchEvent($headerLink$$,$headerLink$$,chatmate.controllers.PageController.openHomePage);return $pageModel$$.getContent()}}}}();